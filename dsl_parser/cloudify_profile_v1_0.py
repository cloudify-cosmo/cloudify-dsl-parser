...
from .elements import (
    ...
    RelationshipMapping, CloudifyRelationshipMapping,
...
def extend_cloudify_version_1_0():
    ...
    return dict(
        element_extensions=chain([
            ...
            cloudify_relationships_extension,
...
cloudify_relationships_extension = ElementExtension(
    action=ElementExtension.REPLACE_ELEMENT_ACTION,
    target_element=RelationshipMapping,
    new_element=CloudifyRelationshipMapping)
