...
from aria.parser.framework.elements.node_templates import NodeTemplates
...
class CloudifyRelationshipMapping(RelationshipMapping):
    types = {
        'depens_on_relationship_type': 'cloudify.relationships.depends_on',
        'contained_in_relationship_type': 'cloudify.relationships.contained_in',
        'contained_to_relationship_type': 'cloudify.relationships.connected_to',
        'group_contained_in_relationship_type': '__group_contained_in__',
        'connection_type': 'connection_type',

    }
    assert set(types.keys()) == set(RelationshipMapping.types.keys())
